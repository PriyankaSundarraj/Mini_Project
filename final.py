...
Original file is located at
    https://colab.research.google.com/drive/1kvMycCDM04wjRlIpd9MKq5gbfRXLqntO
"""
...
def chatgpt(prompt):
    ...
    def get_text():
      ...
      input_text = st.text_input("User: ","Hi! I am Priyanka. What's your handle? ",key="input")
      return input_text
    user_input = get_text()
    if user_input:
...
aai.settings.api_key = f"06c2afe60d8f4a58981704e636d5122e"


def SoundScribe():
    # Streamlit app title and description
    st.title("Sound Scribe🎙️➡️📝")
    st.write("AssemblyAI Audio Transcription - This app allows you to transcribe audio files using AssemblyAI.")
    ...
    if audio_file:
        ...
        # Create an AssemblyAI transcriber
        ...
        st.write(transcript.text)  # Access the transcription text
...
# Set up the AssemblyAI API key
aai.settings.api_key = openai.api_key  # Use the same API key from your Streamlit app

# ... (Rest of your code remains the same)
users_choice = st.sidebar.selectbox("What feature you want to use?", options=['ChatGPT', 'DallE2', 'PandasAI', 'Excel_Plotter', 'SoundScribe'])
